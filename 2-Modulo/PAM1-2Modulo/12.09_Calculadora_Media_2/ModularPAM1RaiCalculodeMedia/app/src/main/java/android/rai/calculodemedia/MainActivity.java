package android.rai.calculodemedia;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void validaCampos() {
        if (TextUtils.isEmpty(nota1.getText())) {
            nota1.setError("Esso campo nao pode estar vazio");
        } else if (TextUtils.isEmpty(nota2.getText())) {
            nota2.setError("Esso campo nao pode estar vazio");
        } else if (TextUtils.isEmpty(nota3.getText())) {
            nota3.setError("Esso campo nao pode estar vazio");
        } else if (TextUtils.isEmpty(nota4.getText())) {
            nota4.setError("Esso campo nao pode estar vazio");
        } else if (TextUtils.isEmpty(faltas.getText())) {
            faltas.setError("Esso campo nao pode estar vazio");
        }
    }
    ...
    public void initComponents() {
        ...
        txtResultado = findViewById(R.id.txt_resutado);
